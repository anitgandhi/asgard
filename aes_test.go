...
func TestCipherEncrypt(t *testing.T) {
	for i, tt := range encryptTests {
		// make a local copy of tt.key since memguard will wipe the original
		// this is only because the encryptTests variable is re-used across tests
		// in a real world scenario this wouldn't be needed
		tempKey := append([]byte{}, tt.key...)
		c, err := NewCipher(tempKey)
		if err != nil {
